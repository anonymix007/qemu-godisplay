...
func NewDmaPicture(fd int, width, height, stride, fourcc uint32, modifier uint64, y0_top bool) Picture {
    ...
    // Based on _print_all_dma_formats from logs, only 0x0200000000000901, 0x0200000000401902, 0x0200000000401b03 and 0x020000000056bb03 are supported on 7950x
    // None of these is correct though
    if modifier == 0xffffffffffffff {
        //modifier = 0

        //modifier = 0x0200000000000901
        //modifier = 0x0200000000401902
        modifier = 0x0200000000401b03
    }
